# This package was copied from perl/tk for inclusion into Tcl::Tk so that traceVariable methods
#  can be supported, for compatiblity with perl/tk

package Tcl::Tk::Tie::Watch;
...
=head1 NAME
 ...
 Tcl::Tk::Tie::Watch - place watchpoints on Perl variables.

=head1 SYNOPSIS

 use Tcl::Tk::Tie::Watch;

 $watch = Tcl::Tk::Tie::Watch->new(
     -variable => \$frog,
     -debug    => 1,
     -shadow   => 0,
...
Tcl::Tk::Tie::Watch provides default callbacks for any that you fail to
...
=item $watch = Tcl::Tk::Tie::Watch->new(-options => values);
...
prevent infinite recursion Tcl::Tk::Tie::Watch maintains parallel variables for
...
sub new {
    ...
    # Watch constructor.  The *real* constructor is Tcl::Tk::Tie::Watch->base_watch(),
    ...
    my($class, %args) = @_;
    my $version = $Tcl::Tk::Watch::VERSION;
    my (%arg_defaults) = (-debug => 0, -shadow  => 1);
    my $variable = $args{-variable};
    croak "Tcl::Tk::Tie::Watch::new(): -variable is required." if not defined $variable;

    my($type, $watch_obj) = (ref $variable, undef);
    if ($type =~ /(SCALAR|REF)/) {
	@arg_defaults{@scalar_callbacks} = (
	    [\&Tcl::Tk::Tie::Watch::Scalar::Destroy],  [\&Tcl::Tk::Tie::Watch::Scalar::Fetch],
	    [\&Tcl::Tk::Tie::Watch::Scalar::Store]);
    } elsif ($type =~ /ARRAY/) {
	@arg_defaults{@array_callbacks}  = (
	    [\&Tcl::Tk::Tie::Watch::Array::Clear],     [\&Tcl::Tk::Tie::Watch::Array::Destroy],
	    [\&Tcl::Tk::Tie::Watch::Array::Extend],    [\&Tcl::Tk::Tie::Watch::Array::Fetch],
	    [\&Tcl::Tk::Tie::Watch::Array::Fetchsize], [\&Tcl::Tk::Tie::Watch::Array::Pop],
            [\&Tcl::Tk::Tie::Watch::Array::Push],      [\&Tcl::Tk::Tie::Watch::Array::Shift],
            [\&Tcl::Tk::Tie::Watch::Array::Splice],    [\&Tcl::Tk::Tie::Watch::Array::Store],
            [\&Tcl::Tk::Tie::Watch::Array::Storesize], [\&Tcl::Tk::Tie::Watch::Array::Unshift]);
    } elsif ($type =~ /HASH/) {
	@arg_defaults{@hash_callbacks}   = (
	    [\&Tcl::Tk::Tie::Watch::Hash::Clear],      [\&Tcl::Tk::Tie::Watch::Hash::Delete],
	    [\&Tcl::Tk::Tie::Watch::Hash::Destroy],    [\&Tcl::Tk::Tie::Watch::Hash::Exists],
            [\&Tcl::Tk::Tie::Watch::Hash::Fetch],      [\&Tcl::Tk::Tie::Watch::Hash::Firstkey],
            [\&Tcl::Tk::Tie::Watch::Hash::Nextkey],    [\&Tcl::Tk::Tie::Watch::Hash::Store]);
    } else {
	croak "Tcl::Tk::Tie::Watch::new() - not a variable reference.";
    }
    ...
    if ($type =~ /(SCALAR|REF)/) {
        $watch_obj = tie $$variable, 'Tcl::Tk::Tie::Watch::Scalar', %ahsh;
    } elsif ($type =~ /ARRAY/) {
        $watch_obj = tie @$variable, 'Tcl::Tk::Tie::Watch::Array',  %ahsh;
    } elsif ($type =~ /HASH/) {
        $watch_obj = tie %$variable, 'Tcl::Tk::Tie::Watch::Hash',   %ahsh;
    }
    $watch_obj;
...
sub Unwatch {
	...
	croak "Tcl::Tk::Tie::Watch::Delete() - not a variable reference.";
    }
...
sub normalize_callbacks {
	...
	if ($ref =~ /CODE/) {
	    ...
	    croak "Tcl::Tk::Tie::Watch:  malformed callback $arg=$cb.";
	}
    }
...
package Tcl::Tk::Tie::Watch::Scalar;

use Carp;
@Tcl::Tk::Tie::Watch::Scalar::ISA = qw/Tcl::Tk::Tie::Watch/;

sub TIESCALAR {

    my($class, %args) = @_;
    my $variable = $args{-variable};
    my $watch_obj = Tcl::Tk::Tie::Watch->base_watch(%args);
...
sub Info {$_[0]->SUPER::Info('-value', @Tcl::Tk::Tie::Watch::scalar_callbacks)}
...
package Tcl::Tk::Tie::Watch::Array;

use Carp;
@Tcl::Tk::Tie::Watch::Array::ISA = qw/Tcl::Tk::Tie::Watch/;
...
sub Info {$_[0]->SUPER::Info('-ptr', @Tcl::Tk::Tie::Watch::array_callbacks)}
...
package Tcl::Tk::Tie::Watch::Hash;

use Carp;
@Tcl::Tk::Tie::Watch::Hash::ISA = qw/Tcl::Tk::Tie::Watch/;
...
sub Info {$_[0]->SUPER::Info('-ptr', @Tcl::Tk::Tie::Watch::hash_callbacks)}
