...
# Modified for inclusion into Tcl::Tk 10/20/08

package Tcl::Tk::After;
use Carp;
...
sub Tcl::Tk::After::Cancelled::once { }
sub Tcl::Tk::After::Cancelled::repeat { }
...
sub new
{
 ...
 my $obj   = bless [$w,undef,$t,$method,Tcl::Tk::Callback->new($cb)],$class;
 return $obj->submit;
}
