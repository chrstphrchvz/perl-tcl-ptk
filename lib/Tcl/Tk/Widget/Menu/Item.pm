...
package Tcl::Tk::Widget::Menu::Item;
...
package Tcl::Tk::Widget::Menu::Separator;
use base qw(Tcl::Tk::Widget::Menu::Item);
Tcl::Tk::Widget::Menu->Construct( 'Separator' );
sub kind { return undef }

package Tcl::Tk::Widget::Menu::Button;
use base qw(Tcl::Tk::Widget::Menu::Item);
Tcl::Tk::Widget::Menu->Construct( 'Button' );
Tcl::Tk::Widget::Menu->Construct( 'Command' );

#package Tk::Menu::Command;
#use base qw(Tk::Menu::Button);
#Construct Tk::Menu 'Command';

package Tcl::Tk::Widget::Menu::Cascade;
use base qw(Tcl::Tk::Widget::Menu::Item);
Tcl::Tk::Widget::Menu->Construct( 'Cascade' );
...
package Tcl::Tk::Widget::Menu::Checkbutton;
use base qw(Tcl::Tk::Widget::Menu::Item);
Tcl::Tk::Widget::Menu->Construct( 'Checkbutton' );
sub kind { return 'checkbutton' }

package Tcl::Tk::Widget::Menu::Radiobutton;
use base qw(Tcl::Tk::Widget::Menu::Item);
Tcl::Tk::Widget::Menu->Construct( 'Radiobutton' );
