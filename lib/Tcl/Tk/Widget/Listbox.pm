...
package Tcl::Tk::Widget::Listbox;

@Tcl::Tk::Widget::Listbox::ISA = (Tcl::Tk::Widget);
...
sub configure{
        ...
        if( defined($args{-listvariable})  ){
                ...
                if( defined($listvariable) and ref($listvariable) eq 'ARRAY'){
                        ...
                        #   Listbox
                        tie @$listvariable, 'Tcl::Tk::Widget::Listbox', $self;
                ...
                if( !defined($listvariable) && 
                     defined( $currentListVar = $self->Tcl::Tk::Derived::_cget(-listvariable)) &&
                     tied($$currentListVar)){
                ...
                $self->Tcl::Tk::Derived::_configure(-listvariable, $listvariable);
...
sub cget {
    ...
    if( $option eq '-listvariable'){  # return the store list variable
        return $self->Tcl::Tk::Derived::_cget(-listvariable);        
    }
