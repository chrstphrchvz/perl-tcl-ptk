...
#
# John Cerney 10/24/08: Modified for Tcl::Tk
...
use base  qw(Tcl::Tk::Derived Tcl::Tk::Widget::Tree);
use strict;

Construct Tcl::Tk::Widget 'DirTree';
...
sub add_to_tree {
    ...
    if ( !UNIVERSAL::isa($image, 'Tcl::Tk::Widget::Image') ) {
...
{
    package Tcl::Tk::Widget::DirTreeDialog;
    use base qw(Tcl::Tk::Widget::Toplevel);
    Construct Tcl::Tk::Widget 'DirTreeDialog';
	...
	exists &Tc::Tk::Widget::DirTree::chdir ? $d->chdir($w->{curr_dir}) : $d->set_dir($w->{curr_dir});
