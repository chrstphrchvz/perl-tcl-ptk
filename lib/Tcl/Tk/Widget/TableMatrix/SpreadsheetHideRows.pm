...
Tcl::Tk::Widget::TableMatrix::SpreadsheetHideRows - Table Display with selectable hide/un-hide of rows
...
L<Tcl::Tk::Widget::TableMatrix::SpreadsheetHideRows> is a L<Tcl::Tk::Widget::TableMatrix::Spreadsheet>-derived widget that implements
...
In addition the standard L<Tcl::Tk::Widget::TableMatrix> widget options. The following options are implemented:
...
package Tcl::Tk::Widget::TableMatrix::SpreadsheetHideRows;
...
use base qw/ Tcl::Tk::Derived Tcl::Tk::Widget::TableMatrix::Spreadsheet/;

$VERSION = '1.23';


Tcl::Tk::Widget->Construct("SpreadsheetHideRows");
