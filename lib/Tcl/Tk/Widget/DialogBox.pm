...
# Modified from the Perl/Tk version for inclusion into Tcl::Tk
package Tcl::Tk::Widget::DialogBox;
...
Tcl::Tk::Widget->Construct('DialogBox');
...
sub Populate {
    ...
    $top->configure(-relief => 'raised', -bd => 1) unless $Tcl::Tk::platform eq 'MSWin32';
    my $bot = $cw->Component('Frame', 'bottom');
    $bot->configure(-relief => 'raised', -bd => 1) unless $Tcl::Tk::platform eq 'MSWin32';
