...
#   The original perl/tk approach can't be used for Tcl::Tk, because it uses the ManageGeometry methods,
#    which aren't supported in Tcl::Tk
#

package Tcl::Tk::Widget::Table;
use strict;

use Tcl::Tk::Widget::TableMatrix;

use base qw(Tcl::Tk::Derived Tcl::Tk::Widget::Frame);

Construct Tcl::Tk::Widget 'Table';
