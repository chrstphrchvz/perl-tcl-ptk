...
Tcl::Tk::XEvent - Limited Support for perl/tk's XEvent in Tcl::Tk
...
I<Tcl::Tk::XEvent> provides (very) limited support for perl/tk's XEvent mechanism in Tcl::Tk. Currently it only provides
...
#
sub Tcl::Tk::Widget::XEvent{
        
        my $widget = shift;
        
        my $self = bless {'widget' => $widget }, 'Tcl::Tk::XEvent';
