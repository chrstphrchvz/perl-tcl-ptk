...
#    "use Tk::Tree" is encountered, the file "Tcl/pTk/Widget/Tree.pm" is loaded instead
$translateList = { 
        'Tk.pm'         =>  '',
        'Tk/Tree.pm'    =>  'Tcl/pTk/Widget/Tree.pm',
        'Tk/Balloon.pm'    =>  '',
        'Tk/Bitmap.pm'    =>  '',
        'Tk/BrowseEntry.pm'    =>  'Tcl/pTk/Widget/BrowseEntry.pm',
        'Tk/Canvas.pm'    =>  'Tcl/pTk/Widget/Canvas.pm',
        'Tk/Clipboard.pm'    =>  'Tcl/pTk/Widget/Clipboard.pm',
        'Tk/Dialog.pm'    =>  '',
        'Tk/DialogBox.pm'    =>  '',
        'Tk/DirTree.pm'    =>  'Tcl/pTk/Widget/DirTree.pm',
        'Tk/DragDrop.pm'    =>  'Tcl/pTk/Widget/DragDrop.pm',
        'Tk/DropSite.pm'    =>  'Tcl/pTk/Widget/DropSite.pm',
        'Tk/Frame.pm'       =>  '',
        'Tk/Font.pm'       =>  '',
        'Tk/HList.pm'    =>  'Tcl/pTk/Widget/HList.pm',
        'Tk/Image.pm'    =>  'Tcl/pTk/Widget/Image.pm',
        'Tk/ItemStyle.pm'    =>  'Tcl/pTk/Widget/ItemStyle.pm',
        'Tk/LabEntry.pm'    =>  '',
        'Tk/Listbox.pm'    =>  'Tcl/pTk/Widget/Listbox.pm',
        'Tk/MainWindow.pm'    =>  'Tcl/pTk/Widget/MainWindow.pm',
        'Tk/Photo.pm'    =>  'Tcl/pTk/Widget/Photo.pm',
        'Tk/ProgressBar.pm'    =>  'Tcl/pTk/Widget/ProgressBar.pm',
        'Tk/ROText.pm'    =>  'Tcl/pTk/Widget/ROText.pm',
        'Tk/Table.pm'    =>  'Tcl/pTk/Widget/Table.pm',
        'Tk/Text.pm'    =>  'Tcl/pTk/Widget/Text.pm',
        'Tk/TextEdit.pm'    =>  'Tcl/pTk/Widget/TextEdit.pm',
        'Tk/TextUndo.pm'    =>  'Tcl/pTk/Widget/TextUndo.pm',
        'Tk/Toplevel.pm'    =>  '',
        'Tk/Tiler.pm'    =>  'Tcl/pTk/Widget/Tiler.pm',
        'Tk/widgets.pm' =>  'Tcl/pTk/widgets.pm',
        'Tk/LabFrame.pm' => '',
        'Tk/Submethods.pm' => 'Tcl/pTk/Widget/Submethods.pm',
        'Tk/Menu.pm'       => '',
        ...
        'Tk/NoteBook.pm'     => '',
        'Tk/NBFrame.pm'     => '',
        'Tk/Pane.pm'     => 'Tcl/pTk/Widget/Pane.pm',
        'Tk/Adjuster.pm'     => 'Tcl/pTk/Widget/Adjuster.pm',
        'Tk/TableMatrix.pm'     => 'Tcl/pTk/Widget/TableMatrix.pm',
        'Tk/TableMatrix/Spreadsheet.pm'     => 'Tcl/pTk/Widget/TableMatrix/Spreadsheet.pm',
        'Tk/TableMatrix/SpreadsheetHideRows.pm'     => 'Tcl/pTk/Widget/TableMatrix/SpreadsheetHideRows.pm',
};
