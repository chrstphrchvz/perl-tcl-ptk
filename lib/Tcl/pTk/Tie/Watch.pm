...
With Tcl::pTk::Tie::Watch you can:
...
Tcl::pTk::Tie::Watch provides default callbacks for any that you fail to
...
=item $watch = Tcl::pTk::Tie::Watch->new(-options => values);
...
to Tcl::pTk::Tie::Watch.

B<-shadow> (default 1) is 0 to disable array and hash shadowing.  To
prevent infinite recursion Tcl::pTk::Tie::Watch maintains parallel variables for
...
sub new {
    ...
    # Watch constructor.  The *real* constructor is Tcl::pTk::Tie::Watch->base_watch(),
    ...
    my($class, %args) = @_;
    my $version = $Tcl::pTk::Watch::VERSION;
    my (%arg_defaults) = (-debug => 0, -shadow  => 1);
    my $variable = $args{-variable};
    croak "Tcl::pTk::Tie::Watch::new(): -variable is required." if not defined $variable;

    my($type, $watch_obj) = (ref $variable, undef);
    if ($type =~ /(SCALAR|REF)/) {
	@arg_defaults{@scalar_callbacks} = (
	    [\&Tcl::pTk::Tie::Watch::Scalar::Destroy],  [\&Tcl::pTk::Tie::Watch::Scalar::Fetch],
	    [\&Tcl::pTk::Tie::Watch::Scalar::Store]);
    } elsif ($type =~ /ARRAY/) {
	@arg_defaults{@array_callbacks}  = (
	    [\&Tcl::pTk::Tie::Watch::Array::Clear],     [\&Tcl::pTk::Tie::Watch::Array::Destroy],
	    [\&Tcl::pTk::Tie::Watch::Array::Extend],    [\&Tcl::pTk::Tie::Watch::Array::Fetch],
	    [\&Tcl::pTk::Tie::Watch::Array::Fetchsize], [\&Tcl::pTk::Tie::Watch::Array::Pop],
            [\&Tcl::pTk::Tie::Watch::Array::Push],      [\&Tcl::pTk::Tie::Watch::Array::Shift],
            [\&Tcl::pTk::Tie::Watch::Array::Splice],    [\&Tcl::pTk::Tie::Watch::Array::Store],
            [\&Tcl::pTk::Tie::Watch::Array::Storesize], [\&Tcl::pTk::Tie::Watch::Array::Unshift]);
    } elsif ($type =~ /HASH/) {
	@arg_defaults{@hash_callbacks}   = (
	    [\&Tcl::pTk::Tie::Watch::Hash::Clear],      [\&Tcl::pTk::Tie::Watch::Hash::Delete],
	    [\&Tcl::pTk::Tie::Watch::Hash::Destroy],    [\&Tcl::pTk::Tie::Watch::Hash::Exists],
            [\&Tcl::pTk::Tie::Watch::Hash::Fetch],      [\&Tcl::pTk::Tie::Watch::Hash::Firstkey],
            [\&Tcl::pTk::Tie::Watch::Hash::Nextkey],    [\&Tcl::pTk::Tie::Watch::Hash::Store]);
    } else {
	croak "Tcl::pTk::Tie::Watch::new() - not a variable reference.";
    }
    ...
    if ($type =~ /(SCALAR|REF)/) {
        $watch_obj = tie $$variable, 'Tcl::pTk::Tie::Watch::Scalar', %ahsh;
    } elsif ($type =~ /ARRAY/) {
        $watch_obj = tie @$variable, 'Tcl::pTk::Tie::Watch::Array',  %ahsh;
    } elsif ($type =~ /HASH/) {
        $watch_obj = tie %$variable, 'Tcl::pTk::Tie::Watch::Hash',   %ahsh;
    }
    $watch_obj;
...
sub Unwatch {
	...
	croak "Tcl::pTk::Tie::Watch::Delete() - not a variable reference.";
    }
...
sub normalize_callbacks {
	...
	if ($ref =~ /CODE/) {
	    ...
	    croak "Tcl::pTk::Tie::Watch:  malformed callback $arg=$cb.";
	}
    }
...
package Tcl::pTk::Tie::Watch::Scalar;

use Carp;
@Tcl::pTk::Tie::Watch::Scalar::ISA = qw/Tcl::pTk::Tie::Watch/;

sub TIESCALAR {

    my($class, %args) = @_;
    my $variable = $args{-variable};
    my $watch_obj = Tcl::pTk::Tie::Watch->base_watch(%args);
...
sub Info {$_[0]->SUPER::Info('-value', @Tcl::pTk::Tie::Watch::scalar_callbacks)}
...
package Tcl::pTk::Tie::Watch::Array;

use Carp;
@Tcl::pTk::Tie::Watch::Array::ISA = qw/Tcl::pTk::Tie::Watch/;
...
sub Info {$_[0]->SUPER::Info('-ptr', @Tcl::pTk::Tie::Watch::array_callbacks)}
...
package Tcl::pTk::Tie::Watch::Hash;

use Carp;
@Tcl::pTk::Tie::Watch::Hash::ISA = qw/Tcl::pTk::Tie::Watch/;
...
sub Info {$_[0]->SUPER::Info('-ptr', @Tcl::pTk::Tie::Watch::hash_callbacks)}
